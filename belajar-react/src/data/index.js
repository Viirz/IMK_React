...
export const beritaTerbaru = [
  ...
  },
  {
    ...
    isiBerita: "Blimbing (malangkota.go.id). Suhu atau cuaca panas ekstrem yang melanda saat ini dapat mengganggu daya tahan tubuh dan memicu timbulnya penyakit yang disebabkan oleh debu, seperti halnya Infeksi Saluran Pernafasan Akut (ISPA).",

  },
  {
    id: 3,
    path: "/beritaPemerintahan",
    judulBerita:"Pendidikan Kota Malang Dapat Dana Alokasi Khusus 223,8 M Dari Kemendikbud Ristek.",
    isiBerita: "Pemerintah melalui Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi (Kemendikbudristek) mengalokasikan Dana Alokasi Khusus (DAK) sebesar Rp223,835 miliar untuk pembangunan pendidikan di kota Malang pada Tahun Anggaran 2023.",

  },
  {
    id: 4,
    path: "/beritaPendidikan",
    judulBerita:"Penyesuaian Target PAD 2024, Ini Penjelasan Pj Wali Kota Malang",
    isiBerita: "Klojen (malangkota.go.id) Dalam Rapat Paripurna DPRD Kota Malang yang digelar pada Jumat (3/11/2023) di Ruang Rapat Paripurna DPRD Kota Malang, target Pendapatan Asli Daerah (PAD) Kota Malang tahun 2024 mengalami penyesuaian. Dari target awal sebesar Rp1,2 triliun menjadi Rp800 miliar atau turun sekitar Rp 400 miliar.",
  ...
  },
  {
    ...
    isiBerita: "Di tahun 2045, Indonesia juga akan diprediksi menjadi empat negara raksasa di dunia. Maka dari itu mulai sekarang penataan yang baik di semua bidang harus dilakukan. Seperti halnya perekonomian yang kuat dan sumber daya manusia yang berdaya saing.",
...
export const beritaEkonomi = [
  {
    id : 1,
    berita : "Malang Jadi Target Pasar Rokok Ilegal, Bea Cukai Intensifkan Operasi",
  },
  {
    id : 2,
    berita : "Operasi Pasar Jadi Alat Utama Meredam Fluktuasi Harga di Kota Malang",
  },
  {
    id : 3,
    berita : "Penjualan Rumah Tipe Menengah-Atas di Malang Diproyeksi Tumbuh 40%",
  },
  {
    id : 4,
